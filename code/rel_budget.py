...
def main(args):
    ...
    train_dataloader = get_processed_sentences_budget(args.data_name, 'train', annotation_cost, args.max_len,
                                                      args.batch_size, tokenizer, args.down_sample,
                                                      args.down_sample_rate)

    dev_dataloader = get_processed_sentences_budget(args.data_name, 'dev', None, args.max_len,
                                                    args.batch_size, tokenizer)

    test_dataloader = get_processed_sentences_budget(args.data_name, 'test', None, args.max_len,
                                                     args.batch_size, tokenizer)
